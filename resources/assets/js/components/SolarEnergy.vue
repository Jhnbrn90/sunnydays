  ...
  <div>
    ...
    <div class="w-full flex items-center justify-center">
      <div class="w-1/3 flex justify-center">
        <div class="rounded-xl border border-gray-600 shadow px-3 py-2 sm:p-4 text-center">
          <span class="font-semibold sm:font-medium d-block text-lg sm:text-2xl tracking-wider">Today</span>
          <span class="font-thin">kWh</span>
